...
export type PlasmicMovieItem__VariantMembers = {
  addIcon: "withAddIcon" | "disabled";
  deleteIcon: "withDeleteIcon";
};
export type PlasmicMovieItem__VariantsArgs = {
  addIcon?: SingleChoiceArg<"withAddIcon" | "disabled">;
  deleteIcon?: SingleChoiceArg<"withDeleteIcon">;
};
    ...
    () => [
      {
        ...
        initFunc: ({ $props, $state, $queries, $ctx }) => $props.addIcon
      },
      {
        path: "deleteIcon",
        type: "private",
        variableType: "variant",
        initFunc: ({ $props, $state, $queries, $ctx }) => $props.deleteIcon
      }
    ],
    [$props, $ctx]
  );
    ...
    >
      <p.Stack
        ...
        className={classNames(projectcss.all, sty.freeBox, {
          [sty.freeBoxaddIcon_withAddIcon]: hasVariant(
            $state,
            "addIcon",
            "withAddIcon"
          )
      ...
      >
        <MovieItemIcon
          ...
          _delete={
            hasVariant($state, "deleteIcon", "withDeleteIcon")
              ? true
              : undefined
          }
          className={classNames("__wab_instance", sty.movieItemIcon, {
            [sty.movieItemIconaddIcon_disabled]: hasVariant(
              $state,
              "addIcon",
              "disabled"
            ),
            [sty.movieItemIconaddIcon_withAddIcon]: hasVariant(
              $state,
              "addIcon",
              "withAddIcon"
            ),
            [sty.movieItemIcondeleteIcon_withDeleteIcon]: hasVariant(
              $state,
              "deleteIcon",
              "withDeleteIcon"
            )
          ...
          disabled={
            hasVariant($state, "addIcon", "disabled") ? true : undefined
          }
        />
        ...
        {p.renderPlasmicSlot({
          ...
          className: classNames(sty.slotTargetChildren, {
            [sty.slotTargetChildrenaddIcon_withAddIcon]: hasVariant(
              $state,
              "addIcon",
              "withAddIcon"
            )
